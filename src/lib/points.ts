...
// Points a student has actually been awarded — the number shown in the nav.
...
export async function approvedPointsForStudent(student: Student): Promise<number> {
